//variables for audio
// used help from this link to play audio https://stackoverflow.com/questions/9419263/how-to-play-audio
let audio = new Audio("background.mp3");
let audioDeadline = new Audio("deadline.mp3");
let audioAssignment = new Audio("assignment.mp3");
let audioWin = new Audio("win.mp3");
let audioLost = new Audio("youlose.mp3");
...
function instructionBook(x, y) {
  ...
  let instructionText =
    "Welcome to the spring semester of Jönköping university. To commence on this journey, you need to make sure to gather all of your assignments within the time limit. In order to do this you need to make it past the deadlines without them catching you. If a deadline catches you, you will lose a life. Make sure to capture all of your assignments, and good luck!";
  textSize(16);
  text(instructionText, 95, 170, 265);
...
function failScreen() {
  ...
  textSize(32);
  textFont("andale mono");
  text(sorry, 200, 110, 250);
  textSize(18);

  text(gradeFail, 200, 220, 400);
  text(gradeConditionsFail, 200, 300, 400);
  ...
  textFont("arial");
  textSize(55);
  text(finalGrade, 562, 102, width);

  fill(247, 147, 30);
  rect(320, 480, 150, 50, 5);
...
function wonScreen() {
  ...
  textSize(32);
  textFont("andale mono");
  text(congrats, 200, 110, 200);
  textSize(18);

  text(grade, 200, 200, 400);
  text(gradeConditions, 200, 250, 400);
  text(caughtAssignments, 200, 300, 400);
  text(caughtDeadlines, 200, 330, 400);
  text(timeComplete, 200, 400, 400);
...
function timeOut() {
  ...
  textSize(32);
  textFont("andale mono");
  text(timeOutTitle, 200, 110, 250);
  textSize(18);

  text(notOnTime, 200, 220, 400);
  text(timeConditions, 200, 300, 400);
...
// gamePage function that has the content in the draw();
